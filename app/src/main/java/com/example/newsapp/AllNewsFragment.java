...
public class AllNewsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public static final String API_KEY = "9882aa9b05c0453aa2efaef5d5d101b2";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        swipeRefreshLayout = (SwipeRefreshLayout)rootView.findViewById(R.id.swipe_refresh_layout_news);
